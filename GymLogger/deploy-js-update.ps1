...
$htmlFiles = Get-ChildItem "wwwroot" -Filter "*.html" -Recurse
...
$jsFiles = Get-ChildItem "wwwroot\js" -Filter "*.js" -Recurse
...
$cssFiles = Get-ChildItem "wwwroot\css" -Filter "*.css" -Recurse -ErrorAction SilentlyContinue
